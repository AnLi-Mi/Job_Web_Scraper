...
class NoFluffJobs():
    ...
    def job_fetch(self):
        ...
        job = soup.find('a', class_="posting-list-item posting-list-item--businessIntelligence highlightId-ZGZ7TSHK")
        self.job_all_details = job
